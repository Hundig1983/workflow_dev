...
Establishes who a caller is: account registration, credential verification, session issuance, session
revocation, and the authentication of every subsequent request. Every family-scoped capability in the
product depends on this one to identify the caller before any authorization decision is made.
